...
def get_args():
  ...
  """
    ...
    parser.add_argument('-ted', '--testing-dir', dest='tedir', default='/mnt/disk2/cyc202/awbformer/HVDualformerW_code/data/mit5k/5k_tdsfc/', help='Testing directory')
    parser.add_argument('-od', '--outdir', dest='outdir', default='./results/Hist_PDFLab_sRGB/16d/mit5k_DSTFC_128/5k_tdsfc/', help='Results directory')
    ...
    parser.add_argument('-mn', '--model-name', dest='model_name', type=str,
                        default='ifrnet_p_64_DSTFC',
                        # default='WB_model_p_64_D_S_T',
                        help='Model name')
    parser.add_argument('-emb', '--embed_dim', dest='embed_dim', type=int, default=16, help='embed_dim.')
    parser.add_argument('-ckp_path', '--checkpoint_path', dest='ckp_path', type=str, default='/mnt/disk2/cyc202/awbformer/HVDualformerW_code/checkpoints_model/Hist_PDFLab_sRGB/16d/DSTFC_64', help='checkpoint_path.')
